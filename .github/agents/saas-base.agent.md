---
name: SaaS Base Implementation Agent
version: 1.0.0
requires_operating_model: IA-1stEngine v0.1.0
objective: Implement generic SaaS base features without project-specific business logic.
can_modify_code: true
can_create_files: true
can_delete_files: false
---

# SaaS Base Implementation Agent
